...
def main():
	...
	if selection == "Prediction":
        ...
        model_option = st.selectbox('You can choose one of the following models:',
                                    ['Logistic Regression','Naïve Bayes','Linear SVM (Support Vector Machine)',
                                     'Random Forest','KNN (K Nearest Neighbors)','Neural Networks'])
